import { GSS_ENDPOINTS } from "@/lib/gss/client";

/**
 * Os recursos que o painel sabe listar: o endpoint do GSS, a tabela nossa que
 * ele alimenta e quais campos mostrar. Espelha o escopo de `lib/gss/sync.ts` —
 * quando um recurso entrar lá, entra aqui.
 *
