...
- **Corpo padrão só da etapa "pi"** por enquanto (`lib/email/step-templates.ts` — mapa por `ChecklistStep`, hoje só uma entrada preenchida). Texto continua 100% editável — é ponto de partida, não trava nada. ⚠️ **Revisado em 10/09** — ver bullet abaixo, a versão bilíngue original foi removida.
- **Fora de escopo desta rodada:** corpo padrão pras outras 23 etapas.
