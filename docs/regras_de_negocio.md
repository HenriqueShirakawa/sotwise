...
- Código: `lib/email/threads.ts` (`resolveOwnerThreads`, `findOrCreateThread`, `ThreadOwnerKey`), `lib/checklist-email-actions.ts` (`sendStepEmail`, `customerNameForThread`, `threadByClientId`), `lib/checklist-emails-list-actions.ts`, `domain/client/notifications.ts`; migration `20260922120000_email_threads_owner_columns`.
