...
- **Assunto fixo por pedido: `Order #1637`**, sem a etapa — o Gmail só agrupa quando o assunto é igual (confirmado no spike de 11/09 abaixo). A etapa vai em **destaque no corpo** (`stepLabel` em `checklistStepEmailHtml`, título grande abaixo do assunto). O assunto digitado no compositor (`PL #246` pra PL/Shipment) continua editável e é o que aparece NO CORPO — ⚠️ **desde 16/09/2026 não é mais o assunto do ENVELOPE SMTP de uma cópia de PL/Shipment** (ver "Fan-out por Order" abaixo).
